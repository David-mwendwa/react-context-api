# react-context-api
Replacing the local state management from redux to the new context API. We have crown-clothing as the initial state of the app before I introduced sagas to handle asynchronous code, which is a good starting point to make the appropriate changes!
